...
// fragment. After refresh, Location is the same-origin path from the next
// query parameter (no host, no "//"); the legacy /auth/refresh/*uri form still works. JWTWithRedirect responds 307; the client must follow the
